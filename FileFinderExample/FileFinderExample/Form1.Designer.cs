...
namespace FileFinderExample
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.LabelFileName.Size = new System.Drawing.Size(287, 13);
            ...
            this.ToolTipHints.SetToolTip(this.TextBoxFileName, "Введите имя файла, часть имени или маску (например: *.txt)");
            // 
            ...
            this.ToolTipHints.SetToolTip(this.ButtonSelectSearchDirectory, "Выберите директорию для поиска");
            ...
            this.ToolTipHints.SetToolTip(this.ButtonStartSearch, "Начать поиск файлов");
            ...
            this.ToolTipHints.SetToolTip(this.ListViewFoundFiles, "Список найденных файлов");
            ...
            this.ToolTipHints.SetToolTip(this.ProgressBarMain, "Индикатор прогресса поиска");
            // 
